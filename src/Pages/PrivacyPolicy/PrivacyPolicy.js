  ...
  return (
    <div>
      ...
      <div style={{ marginLeft: '2%' }}>
        <p>Effective date: 2021-03-22</p>
        <p>
          1. <b>Introduction</b>
        </p>
        <p>
          Welcome to <b> discover_north_lebanon</b>.
        </p>
        <p>
          <b>discover_north_lebanon</b> (“us”, “we”, or “our”) operates{' '}
          <b>discover_north_lebanon.com</b> (hereinafter referred to as{' '}
          <b>“Service”</b>).
        </p>
        <p>
          Our Privacy Policy governs your visit to{' '}
          <b>discover_north_lebanon.com</b>, and explains how we collect,
        ...
        <p>
          <b>SERVICE</b> means the discover_north_lebanon.com website operated
          by discover_north_lebanon.
        </p>
        <p>
        ...
        <p>
          discover_north_lebanon uses the collected data for various purposes:
        </p>
        ...
        <p>
          If you are located outside Lebanon and choose to provide information
          to us, please note that we transfer the data, including Personal Data,
          to Lebanon and process it there.
        </p>
        <p>
        ...
        <p>
          discover_north_lebanon will take all the steps reasonably necessary to
        ...
        <p>
          ...
          <b>discover.north.lebanon@gmail.com</b>.
        </p>
        <p>
        ...
        <p>
          ...
          us at <b>discover.north.lebanon@gmail.com</b>.
        </p>
        ...
        <p>
          ...
          by email: <b>discover.north.lebanon@gmail.com</b>.
        </p>
        <p style={{ marginTop: '5em', fontSize: '0.7em' }}>
          This{' '}
          <a href="https://policymaker.io/privacy-policy/">Privacy Policy</a>{' '}
          was created for <b>discover_north_lebanon.com</b> by{' '}
          <a href="https://policymaker.io">PolicyMaker.io</a> on 2021-03-22.
        </p>
      </div>
    </div>
  );
